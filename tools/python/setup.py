...
def get_requirements():
  ...
  this_root = file_path.split("tools/python")[0]
  odin_data_root = get_dependency(this_root, "ODIN_DATA")
  ...
  config_file_path = os.path.join(this_root, "tools/python/odindataclient")
