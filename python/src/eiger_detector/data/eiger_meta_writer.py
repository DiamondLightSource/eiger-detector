...
class EigerMetaWriter(MetaWriter):
    ...
    def _define_detector_datasets(self):
        return [
            ...
            Int64HDF5Dataset(dectris(COUNTRATE_CORRECTION_ENABLED), cache=False),
            ...
            Int32HDF5Dataset(dectris(FLATFIELD_ENABLED), cache=False),
            Float64HDF5Dataset(dectris(FRAME_TIME), cache=False),
            Int32HDF5Dataset(dectris(IMAGE_SIZE_X), cache=False),
            Int32HDF5Dataset(dectris(IMAGE_SIZE_Y), cache=False),
            Int64HDF5Dataset(dectris(IMAGES_PER_TRIGGER), cache=False),
            Float64HDF5Dataset(dectris(INCIDENT_ENERGY), cache=False),
            Float64HDF5Dataset(dectris(INCIDENT_WAVELENGTH), cache=False),
            Int64HDF5Dataset(dectris(NUMBER_OF_IMAGES), cache=False),
            Int64HDF5Dataset(dectris(NUMBER_OF_TRIGGERS), cache=False),
            Int32HDF5Dataset(dectris(PIXEL_MASK_ENABLED), cache=False),
            ...
            Int64HDF5Dataset(dectris(SATURATION_VALUE), cache=False),
            StringHDF5Dataset(dectris(SENSOR_MATERIAL), cache=False),
            Float64HDF5Dataset(dectris(SENSOR_THICKNESS), cache=False),
            Int32HDF5Dataset(dectris(VIRTUAL_PIXEL_INTERPOLATION_ENABLED), cache=False),
            Int64HDF5Dataset(dectris(COUNTRATE_CORRECTION), cache=False),
            ...
            Int32HDF5Dataset(dectris(PIXEL_MASK_1), shape=self._sensor_shape, rank=2, cache=False),
            Int32HDF5Dataset(dectris(PIXEL_MASK_2), shape=self._sensor_shape, rank=2, cache=False),
